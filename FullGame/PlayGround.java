 ...
 * @author Ibrahim
 */
public class PlayGround implements PlayerListener{
    ...
    public PlayGround(){
        ...
        this.firstPlayer.addPlayerListener(this);
        this.secondPlayer = new Player(2);
        this.secondPlayer.setChar('O');
        this.secondPlayer.addPlayerListener(this);
        this.turn = 1;
    }
    ...
    public boolean play(Player source, char x_or_o, int x, int y) {
        if(this.gameGrid[x][y] == null){
            if(source == firstPlayer && turn == 1){
                turn = 2;
                this.gameGrid[x][y] = x_or_o;
                return true;
            }
            else if(source == secondPlayer && turn == 2){
                turn = 1;
                this.gameGrid[x][y] = x_or_o;
                return true;
            }
